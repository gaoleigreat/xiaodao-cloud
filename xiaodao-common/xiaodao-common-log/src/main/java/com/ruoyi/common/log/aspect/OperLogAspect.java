package com.xiaodao.common.log.aspect;
...
import com.xiaodao.common.log.enums.BusinessStatus;
import com.xiaodao.common.log.event.SysOperLogEvent;
import com.xiaodao.common.utils.AddressUtils;
...
import com.xiaodao.common.utils.spring.SpringContextHolder;
...
{
    // 配置织入点
    @Pointcut("@annotation(com.xiaodao.common.log.annotation.OperLog)")
