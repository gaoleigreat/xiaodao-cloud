package com.xiaodao.common.redis.aspect;
...
import com.xiaodao.common.redis.annotation.RedisCache;
import com.xiaodao.common.redis.annotation.RedisEvict;
import com.xiaodao.common.redis.util.RedisUtils;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.xiaodao.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.xiaodao.common.redis.annotation.RedisEvict)")
