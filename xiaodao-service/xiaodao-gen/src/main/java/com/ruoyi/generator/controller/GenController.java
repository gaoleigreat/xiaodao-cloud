package com.xiaodao.generator.controller;
...
import com.xiaodao.generator.service.IGenTableColumnService;
...
public class GenController extends BaseController
{
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=xiaodao.zip");
